...
export const getSubmissionHandler = (request: Request, h: ResponseToolkit) => {
  const { submissionId } = request.params;
  const url = `https://6zy0ta2uxg.execute-api.eu-west-2.amazonaws.com/dev/submissions/${submissionId}`;
